...
cimg_library::CImg<uint8_t> extractXZ_pitch(const cimg_library::CImg<uint8_t>& img, int y,double angle, double video_xyFactor, double video_everyNthFrame);
cimg_library::CImg<uint8_t> extractZY_pitch(const cimg_library::CImg<uint8_t>& img, int x, double angle, double video_xyFactor, double video_everyNthFrame);
